...
output_file_0 = output_file + "_" + str(peak_version) + "_recEm" + str(round(recent_emissions))
output_figure_file_0 = output_figure_file + "_" + str(peak_version)
...
vetted_scen_list_file_foundation = input_folder + "filtered_ar6_full_metadata_indicators2021_10_14_v3/ar6_full_metadata_indicators2021_10_14_v3_{}.xlsx"
...
for vetting in List_vetting:
    vetted_scen_list_file = vetted_scen_list_file_foundation.format(vetting)
    if peak_version and (peak_version == "officialNZ"):
        assert vetted_scen_list_file is not None
    output_file = output_file_0 + "_model_{}.csv".format(vetting)
    output_figure_file = output_figure_file_0 + "_model_{}.pdf".format(vetting)
